...
double func1(const double c, const int k) { return c; }
double func2(const double c, const int k) { return c / k; }
double func3(const double c, const int k) { return k < 2 ? c : c / log2(k); }
double func4(const double c, const int k) { return k < 2 ? c / k : c / k * log2(k); }
double func5(const double c, const int k) { return k < 3 ? c / k : c / k * log(k); }
